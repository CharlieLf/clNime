...
export function FilteredCard({media, filterTitle}){

    var searched = String(media.title.english).toLowerCase()
    let isTrue = searched.includes(filterTitle.toLowerCase())

    if(isTrue){
        return (

            <div className="flex flex-row text-white bg-black text-base m-3">
